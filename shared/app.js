...
// The page sets window.DASH = { url, intervalMs, showSrc?, newWindowMs? } before including this script.
...
(function () {
  ...
  async function refresh() {
    try {
      ...
      const { totalOffers } = CardUI.renderGrid(data, { showShips: true, showSrc: cfg.showSrc !== false, seen, firstRun, newKeys, recent: recentNew, newWindowMs: cfg.newWindowMs });
