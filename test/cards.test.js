...
test("Cardmarket URLs normalize to site=cardmarket with the URL as productUrl", () => {
  ...
  assert.equal(p.productUrl, url); // no blueprint indirection — the URL *is* the product
